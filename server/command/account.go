...
func (r *Runner) handleDisconnect(_ *plugin.Context, args *model.CommandArgs, _ []string, _ *serverplugin.GitHubUserInfo) string {
	r.serverPlugin.DisconnectGitHubAccount(args.UserId)
	return "Disconnected your GitHub account."
}

func (r *Runner) handleTodo(_ *plugin.Context, _ *model.CommandArgs, _ []string, userInfo *serverplugin.GitHubUserInfo) string {
...
func (r *Runner) handleMe(_ *plugin.Context, _ *model.CommandArgs, _ []string, userInfo *serverplugin.GitHubUserInfo) string {
	githubClient := r.serverPlugin.GithubConnectUser(context.Background(), userInfo)
