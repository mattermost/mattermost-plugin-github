...
require (
	...
	github.com/mattermost/mattermost-plugin-api v0.0.28-0.20220617232727-07147da80677
	github.com/mattermost/mattermost-server/v6 v6.0.0-20220617193018-3aa4e4488bf4
