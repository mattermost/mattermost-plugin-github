...
We've set up the Mattermost GitHub plugin, so you can get notifications from GitHub in Mattermost. To get started, follow these steps to connect your GitHub account to your Mattermost client. Then, take a look at the slash commands section for details about how to use the plugin.**
