...
# TODO: This should probably be set by `deploy-e2e` but it can't be because it needs to be set before `dist` runs
...
.PHONY: deploy-e2e
deploy-e2e: dist
	E2E_TESTING=true ./build/bin/pluginctl deploy $(PLUGIN_ID) dist/$(BUNDLE_NAME)
