...
ifdef PLUGIN_E2E_MOCK_GITHUB_API_URL
	GO_BUILD_FLAGS += -ldflags '-X "github.com/mattermost/mattermost-plugin-github/server/plugin.testGithubApiURL=$(PLUGIN_E2E_MOCK_GITHUB_API_URL)"'
endif
.PHONY: deploy-e2e
deploy-e2e: dist
